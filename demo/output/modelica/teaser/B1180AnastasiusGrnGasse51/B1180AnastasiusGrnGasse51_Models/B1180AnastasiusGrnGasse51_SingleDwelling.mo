...
within teaser.B1180AnastasiusGrnGasse51.B1180AnastasiusGrnGasse51_Models;
model B1180AnastasiusGrnGasse51_SingleDwelling
  "This is the simulation model of SingleDwelling within building B1180AnastasiusGrnGasse51 with traceable ID None"
  
  parameter Modelica.Units.SI.HeatFlowRate Q_heat_nominal = 66657.93025199664
  ...
  AixLib.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[23](    each outSkyCon=true,
    ...
    azi = {3.1399630254027646, 1.5593096211256914, 3.141592653589793, -1.5741296477469338, 3.123895386333834, -1.5674630058428574, -1.572316082472761, 1.5674630058428618, -1.5707963267948966, 1.568927975997158, -1.5741296477469306, -1.572664677592635, 1.5707963267948966, -1.5726362511018865, -0.002450975484268492, 3.1399642316391123, -1.5741296479409546, 1.5674630058428591, -0.001629628187028378, -1.5741296477469335, 3.1391416781055246, 3.124816766293183, -0.0015735628239661836})
  ...
  AixLib.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=23,  UWin=3.0017821341055915)
    "Correction factor for solar transmission"
    annotation (Placement(transformation(extent={{6,54},{26,74}})));
  AixLib.ThermalZones.ReducedOrder.RC.FourElements
  thermalZoneFourElements(
    redeclare package Medium = Modelica.Media.Air.DryAirNasa,
    VAir=399.8170510898547,
    hConExt=2.6999999999999997,
    hConWin=2.6999999999999993,
    gWin=0.7800000000000001,
    ratioWinConRad=0.029999999999999995,
    nExt=1,
    RExt={0.00017155733676147797},
    CExt={186995539.72328094},
    hRad=5.0,
    AInt=333.1808759082123,
    hConInt=2.7,
    nInt=1,
    RInt={0.00021821560449009655},
    CInt={60000548.80850464},
    RWin=0.0013428187720217143,
    RExtRem=0.0006200861495328337,
    AFloor=622.2833479997739,
    hConFloor=1.7000000000000002,
    nFloor=1,
    RFloor={0.00027983380722983745},
    RFloorRem=0.0005190231543348246,
    CFloor={79576624.12327078},
    ARoof=280.5344883699118,
    hConRoof=1.7000000000000008,
    nRoof=1,
    RRoof={0.00010061603912757457},
    RRoofRem=0.0010561730339553788,
    CRoof={80695273.5647581},
    ...
    nOrientations=23,
    AWin={3.4695046069599047, 8.194435599029314, 3.9632145000128336, 0.6360035333233467, 0.2836744213305788, 0.6360335334900127, 9.765191877121268, 0.6360035333235877, 2.012999999999975, 14.751681547095798, 0.6360035333235877, 8.732305241076, 1.3355999999999906, 2.3044439006405666, 4.9776149509068155, 3.472074603552266, 0.6360035333237579, 0.6360035333233467, 14.310019001468868, 0.6360635336566784, 8.64880997781332, 3.9651029371381665, 26.945233359583177},
    ATransparent={3.4695046069599047, 8.194435599029314, 3.9632145000128336, 0.6360035333233467, 0.2836744213305788, 0.6360335334900127, 9.765191877121268, 0.6360035333235877, 2.012999999999975, 14.751681547095798, 0.6360035333235877, 8.732305241076, 1.3355999999999906, 2.3044439006405666, 4.9776149509068155, 3.472074603552266, 0.6360035333237579, 0.6360035333233467, 14.310019001468868, 0.6360635336566784, 8.64880997781332, 3.9651029371381665, 26.945233359583177},
    AExt={17.347523034799522, 40.972177995146566, 19.81607250006417, 3.1800176666167332, 1.4183721066528938, 3.1801676674500623, 48.82595938560634, 3.1800176666179385, 10.064999999999873, 73.75840773547898, 3.180017666617939, 43.66152620537999, 6.677999999999952, 11.522219503202832, 24.888074754534077, 17.36037301776133, 3.1800176666187894, 3.1800176666167332, 71.55009500734434, 3.1803176682833922, 43.2440498890666, 19.82551468569083, 134.72616679791588})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  AixLib.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=23,
    wfGro=0.0,
    wfWall={0.02853585998452968, 0.06739730693455985, 0.032596507822516066, 0.00523097958716471, 0.0023331554458937273, 0.005231226331484856, 0.08031640816057849, 0.005230979587166693, 0.016556451901988026, 0.12132911376450022, 0.005230979587166692, 0.0718211583295353, 0.01098499610546216, 0.018953509489212962, 0.040939713125338416, 0.02855699760249775, 0.005230979587168092, 0.00523097958716471, 0.11769654312685396, 0.005231473075805003, 0.07113442941237066, 0.03261203977404885, 0.22161821167699342},
    wfWin={0.028535859984529673, 0.06739730693455982, 0.03259650782251604, 0.0052309795871647085, 0.0023331554458937264, 0.005231226331484856, 0.08031640816057845, 0.005230979587166691, 0.01655645190198802, 0.12132911376450019, 0.0052309795871666905, 0.07182115832953528, 0.010984996105462157, 0.018953509489212955, 0.040939713125338395, 0.028556997602497733, 0.00523097958716809, 0.0052309795871647085, 0.11769654312685392, 0.005231473075805002, 0.07113442941237065, 0.03261203977404884, 0.2216182116769933},
    withLongwave=true,
    aExt=0.5,
    hConWallOut=20.0,
    hRad=5.0,
  ...
  AixLib.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant hConWall(k=25.0*607.9201062874657)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=24.999999999999996*121.58402125749316)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://teaser/B1180AnastasiusGrnGasse51/B1180AnastasiusGrnGasse51_Models/InternalGains_B1180AnastasiusGrnGasse51SingleDwelling.txt"),
    columns={2,3,4})
  ...
  AixLib.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007 eqAirTempVDI(
    ...
    n=10,
    wfWall={0.03032322248455774, 0.035877941633786575, 0.15587615203268584, 0.1677984236091783, 0.010871684320433166, 0.02399704948595826, 0.15603330520466227, 0.24002209980053485, 0.011335504659257374, 0.16786461676894573},
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=7013.362209247797)
    "Outdoor coefficient of heat transfer for roof"
    annotation (Placement(transformation(extent={{4,-4},{-4,4}},rotation=0,
    origin={86,27})));
  Modelica.Blocks.Sources.Constant const1[10](each k=0)
    "Sets sunblind signal to zero (open)" annotation (Placement(transformation(
        extent={{3,-3},{-3,3}},
        rotation=90,
        origin={40,71})));
  Modelica.Blocks.Math.Add solRadRoof[10]
    "Sums up solar radiation of both directions"
    annotation (Placement(transformation(extent={{4,76},{14,86}})));
  AixLib.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTilRoof[10](    til={1.570796326794897, 1.5707963267948963, 2.599027958061224, 0.5424046092897623, 1.570796326794897, 0.0, 0.5425404648832762, 1.570796326794897, 1.5707963267948963, 2.5989746599743593},
    azi={-1.572306899665472, -1.5707963267948966, -1.5724552029820653, 3.1393993974322187, 1.5584512749631254, 0.0, -1.5724435322909676, -1.5725280630988314, 1.5707963267948966, 3.140018082352903})
    "Calculates direct solar radiation on titled surface for both directions"
    annotation (Placement(transformation(extent={{-68,74},{-48,94}})));
  AixLib.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTilRoof[10](    til={1.570796326794897, 1.5707963267948963, 2.599027958061224, 0.5424046092897623, 1.570796326794897, 0.0, 0.5425404648832762, 1.570796326794897, 1.5707963267948963, 2.5989746599743593},
    azi={-1.572306899665472, -1.5707963267948966, -1.5724552029820653, 3.1393993974322187, 1.5584512749631254, 0.0, -1.5724435322909676, -1.5725280630988314, 1.5707963267948966, 3.140018082352903})
...
equation
  ...
  events=false));
end B1180AnastasiusGrnGasse51_SingleDwelling;
