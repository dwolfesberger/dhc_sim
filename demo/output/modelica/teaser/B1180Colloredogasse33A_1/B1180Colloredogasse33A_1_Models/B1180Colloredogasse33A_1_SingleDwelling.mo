...
within teaser.B1180Colloredogasse33A_1.B1180Colloredogasse33A_1_Models;
model B1180Colloredogasse33A_1_SingleDwelling
  "This is the simulation model of SingleDwelling within building B1180Colloredogasse33A_1 with traceable ID None"
  
  parameter Modelica.Units.SI.HeatFlowRate Q_heat_nominal = 40831.249608187194
  ...
  AixLib.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[14](    each outSkyCon=true,
    each outGroCon=true,
    til={1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966},
    azi = {-1.6577559533693393, 1.482299065981538, 3.0536942600094013, -1.6571197277042469, 3.054097312788465, -1.6589209061243648, -1.6587301871358824, -0.08209356333730035, -1.6582916675995398, -1.6689257295900657, -1.6582997916790956, -0.08837678614717227, 3.083217493209566, -0.08788981118373022})
    "Calculates diffuse solar radiation on titled surface for all directions"
    annotation (Placement(transformation(extent={{-68,20},{-48,40}})));
  AixLib.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTil[14](    til={1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966},
    azi={-1.6577559533693393, 1.482299065981538, 3.0536942600094013, -1.6571197277042469, 3.054097312788465, -1.6589209061243648, -1.6587301871358824, -0.08209356333730035, -1.6582916675995398, -1.6689257295900657, -1.6582997916790956, -0.08837678614717227, 3.083217493209566, -0.08788981118373022})
    "Calculates direct solar radiation on titled surface for all directions"
    annotation (Placement(transformation(extent={{-68,52},{-48,72}})));
  AixLib.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=14,  UWin=3.0017821341055915)
    "Correction factor for solar transmission"
    annotation (Placement(transformation(extent={{6,54},{26,74}})));
  AixLib.ThermalZones.ReducedOrder.RC.FourElements
  thermalZoneFourElements(
    redeclare package Medium = Modelica.Media.Air.DryAirNasa,
    VAir=1262.2485641397955,
    hConExt=2.6999999999999997,
    hConWin=2.6999999999999997,
    gWin=0.7799999999999998,
    ratioWinConRad=0.029999999999999995,
    nExt=1,
    RExt={0.00020785944544385055},
    CExt={154337257.62473089},
    hRad=4.999999999999997,
    AInt=1289.5853974497913,
    hConInt=2.515668202764977,
    nInt=1,
    RInt={5.450218671438885e-05},
    CInt={186294836.0397063},
    RWin=0.0016269637344166312,
    RExtRem=0.0007512984615079943,
    AFloor=237.71159399996148,
    hConFloor=1.7000000000000006,
    nFloor=1,
    RFloor={0.0007325512210672181},
    RFloorRem=0.0013587030431882526,
    CFloor={30398187.941685617},
    ARoof=18.435740624414024,
    hConRoof=1.7000000000000002,
    nRoof=1,
    RRoof={0.0015310623876472734},
    RRoofRem=0.016071660355125396,
    CRoof={5303009.771455861},
    ...
    nOrientations=14,
    AWin={8.313453266739021, 8.89020227360171, 28.545204968274557, 2.216798363245004, 1.4581201119611062, 0.5308362881765888, 3.3853567735545065, 0.9997148241050203, 10.935900839577458, 2.4458827199650903, 4.568353255582256, 1.684216971678734, 0.9727809825123144, 25.402868196608537},
    ATransparent={8.313453266739021, 8.89020227360171, 28.545204968274557, 2.216798363245004, 1.4581201119611062, 0.5308362881765888, 3.3853567735545065, 0.9997148241050203, 10.935900839577458, 2.4458827199650903, 4.568353255582256, 1.684216971678734, 0.9727809825123144, 25.402868196608537},
    AExt={41.5672663336951, 44.45101136800855, 142.72602484137278, 11.083991816225021, 7.290600559805531, 2.654181440882944, 16.92678386777253, 4.998574120525101, 54.67950419788729, 12.22941359982545, 22.84176627791128, 8.42108485839367, 4.863904912561572, 127.01434098304269})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  AixLib.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=14,
    wfGro=0.0,
    wfWall={0.08284483270810512, 0.08859222473101687, 0.2844573313085919, 0.022090734579021828, 0.014530389823328455, 0.00528986476237583, 0.03373559777913862, 0.009962311051912611, 0.10897792367365958, 0.024373595214619494, 0.045524338571123445, 0.016783479594588098, 0.009693911202976004, 0.25314346499954216},
    wfWin={0.08284483270810514, 0.08859222473101684, 0.28445733130859185, 0.02209073457902182, 0.014530389823328453, 0.005289864762375831, 0.03373559777913862, 0.009962311051912613, 0.10897792367365959, 0.024373595214619497, 0.04552433857112344, 0.016783479594588098, 0.009693911202976002, 0.2531434649995421},
    withLongwave=true,
    aExt=0.5,
  ...
  Modelica.Blocks.Math.Add solRad[14]
  ...
  Modelica.Blocks.Sources.Constant const[14](each k=0)
  ...
  AixLib.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant hConWall(k=24.999999999999986*501.74844917790955)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=24.999999999999996*100.34968983558191)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://teaser/B1180Colloredogasse33A_1/B1180Colloredogasse33A_1_Models/InternalGains_B1180Colloredogasse33A_1SingleDwelling.txt"),
    columns={2,3,4})
  ...
  AixLib.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007 eqAirTempVDI(
    ...
    hRad=4.999999999999999,
    n=2,
    wfWall={0.33046678862043677, 0.6695332113795632},
    wfWin={0, 0},
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=460.8935156103506)
  ...
  AixLib.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTilRoof[2](    til={0.0, 1.570796326794897},
    azi={0.0, 1.4838367002204536})
    "Calculates direct solar radiation on titled surface for both directions"
    annotation (Placement(transformation(extent={{-68,74},{-48,94}})));
  AixLib.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTilRoof[2](    til={0.0, 1.570796326794897},
    azi={0.0, 1.4838367002204536})
...
equation
  ...
  events=false));
end B1180Colloredogasse33A_1_SingleDwelling;
