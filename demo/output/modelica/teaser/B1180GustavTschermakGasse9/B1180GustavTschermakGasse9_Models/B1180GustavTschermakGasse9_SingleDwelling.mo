...
within teaser.B1180GustavTschermakGasse9.B1180GustavTschermakGasse9_Models;
model B1180GustavTschermakGasse9_SingleDwelling
  "This is the simulation model of SingleDwelling within building B1180GustavTschermakGasse9 with traceable ID None"
  
  parameter Modelica.Units.SI.HeatFlowRate Q_heat_nominal = 3094.7541170506956
  ...
  AixLib.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[4](    each outSkyCon=true,
    ...
    azi = {3.1386340823404404, 1.5667640905800473, -1.5748285630097454, -0.002958571249353081})
  ...
  thermalZoneFourElements(
    ...
    VAir=26.153400000036513,
    hConExt=2.7000000000000006,
    hConWin=2.7,
    gWin=0.78,
    ratioWinConRad=0.030000000000000002,
    nExt=1,
    RExt={0.0028475776739404356},
    CExt={11265875.931949124},
    hRad=5.0,
    AInt=21.79450000003043,
    hConInt=2.7,
    nInt=1,
    RInt={0.0033359455936474284},
    CInt={3924840.9964833413},
    RWin=0.022288646044170517,
    RExtRem=0.010292439301411866,
    AFloor=1.0,
    ...
    ARoof=8.382500000011703,
    hConRoof=1.7000000000000002,
    nRoof=1,
    RRoof={0.0033672853037186707},
    RRoofRem=0.03534661040385993,
    CRoof={2411212.020981868},
    ...
    nOrientations=4,
    AWin={2.112509245544814, 1.550012600755271, 1.550012600755271, 2.112509245544814},
    ATransparent={2.112509245544814, 1.550012600755271, 1.550012600755271, 2.112509245544814},
    AExt={10.56254622772407, 7.750063003776355, 7.750063003776355, 10.56254622772407})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  AixLib.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.28839544638878967, 0.21160455361121036, 0.21160455361121036, 0.28839544638878967},
    wfWin={0.28839544638878967, 0.21160455361121036, 0.21160455361121036, 0.28839544638878967},
    withLongwave=true,
    aExt=0.5,
    hConWallOut=20.0,
  ...
  AixLib.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant hConWall(k=25.0*36.62521846300085)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.000000000000004*7.32504369260017)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://teaser/B1180GustavTschermakGasse9/B1180GustavTschermakGasse9_Models/InternalGains_B1180GustavTschermakGasse9SingleDwelling.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=209.5625000002926)
...
equation
  ...
  events=false));
end B1180GustavTschermakGasse9_SingleDwelling;
