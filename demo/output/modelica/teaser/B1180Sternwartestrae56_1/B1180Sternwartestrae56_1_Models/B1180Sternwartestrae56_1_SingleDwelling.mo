...
within teaser.B1180Sternwartestrae56_1.B1180Sternwartestrae56_1_Models;
model B1180Sternwartestrae56_1_SingleDwelling
  "This is the simulation model of SingleDwelling within building B1180Sternwartestrae56_1 with traceable ID None"
  
  parameter Modelica.Units.SI.HeatFlowRate Q_heat_nominal = 7190.571177986693
  ...
  AixLib.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[4](    each outSkyCon=true,
    ...
    azi = {1.324252826193009, -0.24654146709608268, 2.8951590933538918, -1.8173398273967842})
  ...
  AixLib.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=4,  UWin=3.001782134105591)
    "Correction factor for solar transmission"
    annotation (Placement(transformation(extent={{6,54},{26,74}})));
  AixLib.ThermalZones.ReducedOrder.RC.FourElements
  thermalZoneFourElements(
    redeclare package Medium = Modelica.Media.Air.DryAirNasa,
    VAir=57.86467858048175,
    hConExt=2.7000000000000006,
    hConWin=2.7,
    gWin=0.78,
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.0012611378361638537},
    CExt={25437708.600341417},
    hRad=4.999999999999999,
    AInt=60.63787848383818,
    hConInt=2.495221843003413,
    nInt=1,
    RInt={0.0011544250335822801},
    CInt={8844415.512650331},
    RWin=0.009871216192066275,
    RExtRem=0.004558325045254545,
    AFloor=1.0,
    ...
    ARoof=22.444321219011997,
    hConRoof=1.7000000000000002,
    nRoof=1,
    RRoof={0.0012576129517586586},
    RRoofRem=0.013201244039395927,
    CRoof={6456071.234832635},
    ...
    nOrientations=4,
    AWin={6.64620003445761, 2.3147297501278317, 0.9324031975338833, 6.64620003445761},
    ATransparent={6.64620003445761, 2.3147297501278317, 0.9324031975338833, 6.64620003445761},
    AExt={33.231000172288056, 11.573648750639158, 4.662015987669416, 33.231000172288056})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  AixLib.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.4018372240495775, 0.13995133646203115, 0.05637421543881387, 0.4018372240495775},
    wfWin={0.4018372240495775, 0.13995133646203115, 0.05637421543881388, 0.4018372240495775},
    withLongwave=true,
    aExt=0.5,
  ...
  AixLib.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant hConWall(k=24.999999999999996*82.69766508288468)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=24.999999999999996*16.539533016576936)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://teaser/B1180Sternwartestrae56_1/B1180Sternwartestrae56_1_Models/InternalGains_B1180Sternwartestrae56_1SingleDwelling.txt"),
    columns={2,3,4})
  ...
  AixLib.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007 eqAirTempVDI(
    ...
    hRad=4.999999999999999,
    n=2,
    wfWall={0.2766248281455043, 0.7233751718544956},
    wfWin={0, 0},
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=561.1080304753)
...
equation
  ...
  events=false));
end B1180Sternwartestrae56_1_SingleDwelling;
