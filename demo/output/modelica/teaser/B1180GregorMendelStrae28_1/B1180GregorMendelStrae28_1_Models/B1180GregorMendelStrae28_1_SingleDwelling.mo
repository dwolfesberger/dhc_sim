...
within teaser.B1180GregorMendelStrae28_1.B1180GregorMendelStrae28_1_Models;
model B1180GregorMendelStrae28_1_SingleDwelling
  "This is the simulation model of SingleDwelling within building B1180GregorMendelStrae28_1 with traceable ID None"
  
  parameter Modelica.Units.SI.HeatFlowRate Q_heat_nominal = 4137.812988298206
  ...
  AixLib.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[5](    each outSkyCon=true,
    each outGroCon=true,
    til={1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966},
    azi = {1.5610119032340808, -1.5627319855040886, 3.1268335777395624, 3.130142772295592, 1.578149135468435})
    "Calculates diffuse solar radiation on titled surface for all directions"
    annotation (Placement(transformation(extent={{-68,20},{-48,40}})));
  AixLib.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTil[5](    til={1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966},
    azi={1.5610119032340808, -1.5627319855040886, 3.1268335777395624, 3.130142772295592, 1.578149135468435})
    "Calculates direct solar radiation on titled surface for all directions"
    annotation (Placement(transformation(extent={{-68,52},{-48,72}})));
  AixLib.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=5,  UWin=3.0017821341055915)
    "Correction factor for solar transmission"
    annotation (Placement(transformation(extent={{6,54},{26,74}})));
  AixLib.ThermalZones.ReducedOrder.RC.FourElements
  thermalZoneFourElements(
    redeclare package Medium = Modelica.Media.Air.DryAirNasa,
    VAir=41.03427649944947,
    hConExt=2.6999999999999997,
    hConWin=2.7000000000000006,
    gWin=0.7800000000000001,
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.0023190527930825456},
    CExt={13833430.992555832},
    hRad=4.999999999999999,
    AInt=34.19523041620789,
    hConInt=2.7,
    nInt=1,
    RInt={0.0021261814982942613},
    CInt={6158014.2798201125},
    RWin=0.018151760120817362,
    RExtRem=0.0083821102855265,
    AFloor=1.0,
    hConFloor=1.7000000000000002,
    nFloor=1,
    RFloor={0.1741359184465066},
    RFloorRem=0.322979466168878,
    CFloor={127878.44055132808},
    ARoof=15.436312623730084,
    hConRoof=1.7000000000000002,
    nRoof=1,
    RRoof={0.0018285629312190276},
    RRoofRem=0.019194542695078712,
    CRoof={4440229.353763217},
    ...
    nOrientations=5,
    AWin={3.0722790610593353, 1.4910244830824742, 1.6294294663271018, 1.5752472561547863, 1.2264811539637215},
    ATransparent={3.0722790610593353, 1.4910244830824742, 1.6294294663271018, 1.5752472561547863, 1.2264811539637215},
    AExt={15.361395305296677, 7.45512241541237, 8.147147331635509, 7.876236280773931, 6.132405769818607})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  AixLib.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=5,
    wfGro=0.0,
    wfWall={0.34157454431092416, 0.16577140235096996, 0.18115920344018607, 0.17513525073877162, 0.136359599159148},
    wfWin={0.3415745443109241, 0.16577140235097002, 0.18115920344018618, 0.1751352507387717, 0.136359599159148},
    withLongwave=true,
    aExt=0.5,
  ...
  AixLib.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant hConWall(k=24.999999999999996*44.972307102937094)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=24.999999999999996*8.994461420587418)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://teaser/B1180GregorMendelStrae28_1/B1180GregorMendelStrae28_1_Models/InternalGains_B1180GregorMendelStrae28_1SingleDwelling.txt"),
    columns={2,3,4})
  ...
  AixLib.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007 eqAirTempVDI(
    ...
    hRad=5.0,
    n=2,
    wfWall={0.8831545675526011, 0.11684543244739881},
    wfWin={0, 0},
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=385.9078155932522)
...
equation
  ...
  events=false));
end B1180GregorMendelStrae28_1_SingleDwelling;
