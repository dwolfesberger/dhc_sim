...
within teaser.B1180Cottagegasse27.B1180Cottagegasse27_Models;
model B1180Cottagegasse27_SingleDwelling
  "This is the simulation model of SingleDwelling within building B1180Cottagegasse27 with traceable ID None"
  
  parameter Modelica.Units.SI.HeatFlowRate Q_heat_nominal = 4990.241418760814
  ...
  AixLib.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[3](    each outSkyCon=true,
    each outGroCon=true,
    til={1.5707963267948966, 1.5707963267948966, 1.5707963267948966},
    azi = {-0.26329306102798655, 2.8943592028544005, 1.353040344784178})
    "Calculates diffuse solar radiation on titled surface for all directions"
    annotation (Placement(transformation(extent={{-68,20},{-48,40}})));
  AixLib.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTil[3](    til={1.5707963267948966, 1.5707963267948966, 1.5707963267948966},
    azi={-0.26329306102798655, 2.8943592028544005, 1.353040344784178})
    "Calculates direct solar radiation on titled surface for all directions"
    annotation (Placement(transformation(extent={{-68,52},{-48,72}})));
  AixLib.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=3,  UWin=3.0017821341055915)
    "Correction factor for solar transmission"
    annotation (Placement(transformation(extent={{6,54},{26,74}})));
  AixLib.ThermalZones.ReducedOrder.RC.FourElements
  thermalZoneFourElements(
    redeclare package Medium = Modelica.Media.Air.DryAirNasa,
    VAir=84.49498550973581,
    hConExt=2.6999999999999997,
    hConWin=2.7,
    gWin=0.7800000000000001,
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.004766147383760452},
    CExt={6730899.025596229},
    hRad=4.999999999999999,
    AInt=70.41248792477985,
    hConInt=2.7,
    nInt=1,
    RInt={0.0010325620977704958},
    CInt={12680163.310522238},
    RWin=0.03730573287013633,
    RExtRem=0.017227021793950036,
    AFloor=1.0,
    ...
    ARoof=52.91020908261071,
    hConRoof=1.7000000000000002,
    nRoof=1,
    RRoof={0.0005334749105676455},
    RRoofRem=0.005599920447264839,
    CRoof={15219532.618249543},
    ...
    nOrientations=3,
    AWin={1.7951481108567826, 2.2678321921430764, 0.31343301370902543},
    ATransparent={1.7951481108567826, 2.2678321921430764, 0.31343301370902543},
    AExt={8.975740554283913, 11.33916096071538, 1.567165068545127})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  AixLib.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=3,
    wfGro=0.0,
    wfWall={0.4101870598014623, 0.5181942444706099, 0.07161869572792792},
    wfWin={0.41018705980146203, 0.5181942444706099, 0.07161869572792792},
    withLongwave=true,
    aExt=0.5,
  ...
  AixLib.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant hConWall(k=25.0*21.88206658354442)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.0*4.376413316708884)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://teaser/B1180Cottagegasse27/B1180Cottagegasse27_Models/InternalGains_B1180Cottagegasse27SingleDwelling.txt"),
    columns={2,3,4})
  ...
  AixLib.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007 eqAirTempVDI(
    ...
    hRad=5.0,
    n=4,
    wfWall={0.08525620399227006, 0.3835571529906615, 0.27831821045525623, 0.25286843256181213},
    wfWin={0, 0, 0, 0},
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=1322.755227065268)
  ...
  AixLib.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTilRoof[4](    til={2.458411179728654, 0.3709553480380597, 1.570775631036476, 1.5708014013466574},
    azi={-0.2632154495865593, -0.26330455618417303, 1.3119842973909026, 1.3301965171900536})
    "Calculates direct solar radiation on titled surface for both directions"
    annotation (Placement(transformation(extent={{-68,74},{-48,94}})));
  AixLib.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTilRoof[4](    til={2.458411179728654, 0.3709553480380597, 1.570775631036476, 1.5708014013466574},
    azi={-0.2632154495865593, -0.26330455618417303, 1.3119842973909026, 1.3301965171900536})
...
equation
  ...
  events=false));
end B1180Cottagegasse27_SingleDwelling;
