...
within teaser.B1180AnastasiusGrnGasse47.B1180AnastasiusGrnGasse47_Models;
model B1180AnastasiusGrnGasse47_SingleDwelling
  "This is the simulation model of SingleDwelling within building B1180AnastasiusGrnGasse47 with traceable ID None"
  
  parameter Modelica.Units.SI.HeatFlowRate Q_heat_nominal = 53626.89174962091
  ...
  AixLib.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[18](    each outSkyCon=true,
    each outGroCon=true,
    til={1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966},
    azi = {-0.19118445959845762, -0.19062439991534583, 2.952043047648312, 2.95433873384728, -1.7668276310299929, 2.9515038530571895, 2.924508234892434, 2.950837102396041, 2.950877215111376, 1.3808080388812587, 1.3807465306951106, 1.3811047747684737, -1.7506498264951518, 1.381677477872318, 2.9511725660525006, -1.7608461228946823, 1.3787483095549453, 1.325958422823283})
    "Calculates diffuse solar radiation on titled surface for all directions"
    annotation (Placement(transformation(extent={{-68,20},{-48,40}})));
  AixLib.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTil[18](    til={1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966},
    azi={-0.19118445959845762, -0.19062439991534583, 2.952043047648312, 2.95433873384728, -1.7668276310299929, 2.9515038530571895, 2.924508234892434, 2.950837102396041, 2.950877215111376, 1.3808080388812587, 1.3807465306951106, 1.3811047747684737, -1.7506498264951518, 1.381677477872318, 2.9511725660525006, -1.7608461228946823, 1.3787483095549453, 1.325958422823283})
    "Calculates direct solar radiation on titled surface for all directions"
    annotation (Placement(transformation(extent={{-68,52},{-48,72}})));
  AixLib.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=18,  UWin=3.0017821341055906)
    "Correction factor for solar transmission"
    annotation (Placement(transformation(extent={{6,54},{26,74}})));
  AixLib.ThermalZones.ReducedOrder.RC.FourElements
  thermalZoneFourElements(
    redeclare package Medium = Modelica.Media.Air.DryAirNasa,
    VAir=1276.6061960010447,
    hConExt=2.700000000000001,
    hConWin=2.7000000000000006,
    gWin=0.7800000000000001,
    ratioWinConRad=0.03000000000000001,
    nExt=1,
    RExt={0.00017631252965210974},
    CExt={181952223.38707665},
    hRad=5.0,
    AInt=1392.014896667806,
    hConInt=2.4642436149312377,
    nInt=1,
    RInt={4.997731555747241e-05},
    CInt={205977259.2039699},
    RWin=0.0013800387615521081,
    RExtRem=0.0006372735768122467,
    AFloor=171.041400000335,
    hConFloor=1.7,
    nFloor=1,
    RFloor={0.0010180922188789705},
    RFloorRem=0.0018883116378154382,
    CFloor={21872507.501758765},
    ARoof=136.42496071154972,
    hConRoof=1.7000000000000008,
    nRoof=1,
    RRoof={0.00020689959455543768},
    RRoofRem=0.002171838351027543,
    CRoof={39242410.40610897},
    ...
    nOrientations=18,
    AWin={1.5680297360587376, 18.480037171759303, 12.0586623323426, 0.9603273346566493, 1.4277573865946755, 5.847710109481299, 2.337552571551959, 2.9334898021634803, 6.706512674015665, 4.470382056546907, 19.111884744093555, 4.457965007916376, 0.3479768986527259, 4.056192834889048, 12.250862655397903, 12.197612085743273, 4.565796387434908, 4.526118096259115},
    ATransparent={1.5680297360587376, 18.480037171759303, 12.0586623323426, 0.9603273346566493, 1.4277573865946755, 5.847710109481299, 2.337552571551959, 2.9334898021634803, 6.706512674015665, 4.470382056546907, 19.111884744093555, 4.457965007916376, 0.3479768986527259, 4.056192834889048, 12.250862655397903, 12.197612085743273, 4.565796387434908, 4.526118096259115},
    AExt={7.840148680293688, 92.40018585879652, 60.29331166171299, 4.801636673283246, 7.138786932973377, 29.238550547406497, 11.687762857759795, 14.6674490108174, 33.53256337007832, 22.351910282734533, 95.55942372046775, 22.289825039581878, 1.7398844932636297, 20.280964174445238, 61.2543132769895, 60.98806042871636, 22.82898193717454, 22.630590481295574})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  AixLib.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=18,
    wfGro=0.0,
    wfWall={0.0132541436170427, 0.15620690162320372, 0.10192870626549447, 0.00811739479182572, 0.012068458280507063, 0.049429158031601424, 0.019758718079933506, 0.024796019005820992, 0.05668839060051532, 0.03778696566651327, 0.16154774323813864, 0.03768200761497623, 0.0029413573506258893, 0.0342859329359205, 0.10355332512726426, 0.1031032120448008, 0.0385934779510904, 0.03825808777472508},
    wfWin={0.013254143617042703, 0.15620690162320378, 0.10192870626549447, 0.008117394791825721, 0.012068458280507071, 0.04942915803160145, 0.01975871807993351, 0.024796019005821, 0.056688390600515344, 0.03778696566651328, 0.16154774323813872, 0.037682007614976254, 0.0029413573506258906, 0.034285932935920506, 0.10355332512726431, 0.10310321204480083, 0.038593477951090416, 0.03825808777472509},
    withLongwave=true,
    aExt=0.5,
    hConWallOut=20.0,
  ...
  Modelica.Blocks.Math.Add solRad[18]
  ...
  Modelica.Blocks.Sources.Constant const[18](each k=0)
  ...
  AixLib.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant hConWall(k=24.999999999999996*591.5243494277909)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.000000000000014*118.30486988555816)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://teaser/B1180AnastasiusGrnGasse47/B1180AnastasiusGrnGasse47_Models/InternalGains_B1180AnastasiusGrnGasse47SingleDwelling.txt"),
    columns={2,3,4})
  ...
  AixLib.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007 eqAirTempVDI(
    ...
    n=3,
    wfWall={0.41791325944127505, 0.18532916975313662, 0.3967575708055881},
    wfWin={0, 0, 0},
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=3410.624017788744)
    "Outdoor coefficient of heat transfer for roof"
    annotation (Placement(transformation(extent={{4,-4},{-4,4}},rotation=0,
    origin={86,27})));
  Modelica.Blocks.Sources.Constant const1[3](each k=0)
    "Sets sunblind signal to zero (open)" annotation (Placement(transformation(
        extent={{3,-3},{-3,3}},
        rotation=90,
        origin={40,71})));
  Modelica.Blocks.Math.Add solRadRoof[3]
    "Sums up solar radiation of both directions"
    annotation (Placement(transformation(extent={{4,76},{14,86}})));
  AixLib.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTilRoof[3](    til={0.0, 1.570796326794897, 1.570796326794897},
    azi={0.0, -1.7604878788213192, 1.3798850290384954})
    "Calculates direct solar radiation on titled surface for both directions"
    annotation (Placement(transformation(extent={{-68,74},{-48,94}})));
  AixLib.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTilRoof[3](    til={0.0, 1.570796326794897, 1.570796326794897},
    azi={0.0, -1.7604878788213192, 1.3798850290384954})
...
equation
  ...
  events=false));
end B1180AnastasiusGrnGasse47_SingleDwelling;
