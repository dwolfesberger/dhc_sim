...
within teaser.B1180Colloredogasse33A_2.B1180Colloredogasse33A_2_Models;
model B1180Colloredogasse33A_2_SingleDwelling
  "This is the simulation model of SingleDwelling within building B1180Colloredogasse33A_2 with traceable ID None"
  
  parameter Modelica.Units.SI.HeatFlowRate Q_heat_nominal = 52862.018612917345
  ...
  AixLib.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[11](    each outSkyCon=true,
    ...
    azi = {3.0536942600094013, -1.658387220560737, -0.08980518655475792, 1.4832054330290558, -1.6545995910576505, 3.0517874670350347, 3.053820672548035, 1.4828202504657402, 1.4834280669457591, 3.0156800279007334, 3.053741276778362})
  ...
  AixLib.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=11,  UWin=3.001782134105591)
    "Correction factor for solar transmission"
    annotation (Placement(transformation(extent={{6,54},{26,74}})));
  AixLib.ThermalZones.ReducedOrder.RC.FourElements
  thermalZoneFourElements(
    redeclare package Medium = Modelica.Media.Air.DryAirNasa,
    VAir=1214.9562572002785,
    hConExt=2.7000000000000006,
    hConWin=2.700000000000001,
    gWin=0.7799999999999999,
    ratioWinConRad=0.029999999999999995,
    nExt=1,
    RExt={0.00018660085901612636},
    CExt={171920198.81553054},
    hRad=5.000000000000001,
    AInt=1250.2240676669533,
    hConInt=2.509825673534073,
    nInt=1,
    RInt={5.615350509607925e-05},
    CInt={181107087.09741974},
    RWin=0.0014605678841389889,
    RExtRem=0.0006744602728806785,
    AFloor=237.7605200000545,
    hConFloor=1.7,
    nFloor=1,
    RFloor={0.0007324004777852384},
    RFloorRem=0.001358423451331634,
    CFloor={30404444.522279818},
    ARoof=150.54161202357108,
    hConRoof=1.7000000000000002,
    nRoof=1,
    RRoof={0.00018749811881941072},
    RRoofRem=0.0019681798123988297,
    CRoof={43303041.403962575},
    ...
    nOrientations=11,
    AWin={27.475230248235643, 18.557153266427168, 4.298935749532116, 18.692500136298598, 0.5127996390183881, 4.298935749532116, 17.04512299688648, 7.653719993891257, 2.7906480319143534, 1.6276452984178236, 8.829382078929367},
    ATransparent={27.475230248235643, 18.557153266427168, 4.298935749532116, 18.692500136298598, 0.5127996390183881, 4.298935749532116, 17.04512299688648, 7.653719993891257, 2.7906480319143534, 1.6276452984178236, 8.829382078929367},
    AExt={137.3761512411782, 92.78576633213584, 21.49467874766058, 93.46250068149298, 2.56399819509194, 21.49467874766058, 85.2256149844324, 38.26859996945629, 13.953240159571767, 8.138226492089117, 44.14691039464683})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  AixLib.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=11,
    wfGro=0.0,
    wfWall={0.24579281332311953, 0.16601189025217924, 0.03845818588692942, 0.16722270041171605, 0.004587494437958485, 0.03845818588692942, 0.15248530028651422, 0.06847001290577892, 0.024965076709517395, 0.014560879504038218, 0.07898746039531898},
    wfWin={0.24579281332311959, 0.16601189025217927, 0.03845818588692942, 0.16722270041171605, 0.0045874944379584864, 0.03845818588692942, 0.1524853002865142, 0.0684700129057789, 0.0249650767095174, 0.014560879504038221, 0.07898746039531898},
    withLongwave=true,
    aExt=0.5,
    hConWallOut=20.0,
  ...
  AixLib.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant hConWall(k=25.0*558.9103659454165)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=24.999999999999996*111.78207318908332)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://teaser/B1180Colloredogasse33A_2/B1180Colloredogasse33A_2_Models/InternalGains_B1180Colloredogasse33A_2SingleDwelling.txt"),
    columns={2,3,4})
  ...
  AixLib.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007 eqAirTempVDI(
    ...
    hRad=5.0,
    n=3,
    wfWall={0.1287052778261074, 0.34763534640455734, 0.5236593757693353},
    wfWin={0, 0, 0},
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=3763.540300589279)
  ...
  AixLib.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTilRoof[3](    til={0.0, 1.570796326794897, 1.570796326794897},
    azi={0.0, 1.4808436530619937, -1.6584266264331275})
...
equation
  ...
  events=false));
end B1180Colloredogasse33A_2_SingleDwelling;
