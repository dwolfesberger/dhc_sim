...
within teaser.B1180GustavTschermakGasse3.B1180GustavTschermakGasse3_Models;
model B1180GustavTschermakGasse3_SingleDwelling
  "This is the simulation model of SingleDwelling within building B1180GustavTschermakGasse3 with traceable ID None"
  
  parameter Modelica.Units.SI.HeatFlowRate Q_heat_nominal = 139685.3679508426
  ...
  AixLib.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[21](    each outSkyCon=true,
    each outGroCon=true,
    til={1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966},
    azi = {1.5680757452709861, 3.1281706408530807, 3.1382593326020594, -1.5734053406228277, 1.5679061614290648, 3.141592653589793, 3.1307069109440167, -1.5707963267948966, -0.0021505343191394106, -0.007490496609896279, -1.5736864921607285, 1.5608956601208535, 3.139442119270654, -0.003676454024105238, -1.5812985662871657, 3.1307893582274366, 3.130737262132742, -0.010803295362355827, -0.0021528492036053067, -0.0033333209877334977, -1.5756743368888377})
    "Calculates diffuse solar radiation on titled surface for all directions"
    annotation (Placement(transformation(extent={{-68,20},{-48,40}})));
  AixLib.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTil[21](    til={1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966},
    azi={1.5680757452709861, 3.1281706408530807, 3.1382593326020594, -1.5734053406228277, 1.5679061614290648, 3.141592653589793, 3.1307069109440167, -1.5707963267948966, -0.0021505343191394106, -0.007490496609896279, -1.5736864921607285, 1.5608956601208535, 3.139442119270654, -0.003676454024105238, -1.5812985662871657, 3.1307893582274366, 3.130737262132742, -0.010803295362355827, -0.0021528492036053067, -0.0033333209877334977, -1.5756743368888377})
    "Calculates direct solar radiation on titled surface for all directions"
    annotation (Placement(transformation(extent={{-68,52},{-48,72}})));
  AixLib.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=21,  UWin=3.0017821341055924)
    "Correction factor for solar transmission"
    annotation (Placement(transformation(extent={{6,54},{26,74}})));
  AixLib.ThermalZones.ReducedOrder.RC.FourElements
  thermalZoneFourElements(
    redeclare package Medium = Modelica.Media.Air.DryAirNasa,
    VAir=2524.6457121036597,
    hConExt=2.6999999999999993,
    hConWin=2.7000000000000015,
    gWin=0.7800000000000004,
    ratioWinConRad=0.030000000000000013,
    nExt=1,
    RExt={7.255933746008893e-05},
    CExt={442127201.04903066},
    hRad=5.0,
    AInt=2598.8999977537674,
    hConInt=2.5095238095238095,
    nInt=1,
    RInt={2.7011538122628966e-05},
    CInt={376529415.14921457},
    RWin=0.0005679386394435095,
    RExtRem=0.0002622624075870062,
    AFloor=990.0571420014351,
    hConFloor=1.7000000000000002,
    nFloor=1,
    RFloor={0.00017588471519379653},
    RFloorRem=0.00032622305568743627,
    CFloor={126606963.37584788},
    ARoof=402.8109721983715,
    hConRoof=1.7,
    nRoof=1,
    RRoof={7.007323783762432e-05},
    RRoofRem=0.0007355632844203036,
    CRoof={115867898.4010438},
    ...
    nOrientations=21,
    AWin={43.52288106859183, 0.303778762595245, 9.60065333651851, 8.586165822797666, 11.400747615507708, 1.2800799998882342, 16.7572400516897, 4.738780000000157, 29.761928821574823, 0.5443214701825972, 11.400747615507708, 0.6177260754961884, 21.497929711878125, 17.409205654021648, 2.7176036704351048, 20.191472673908976, 19.34337649596921, 31.696630457688386, 21.47481376536753, 9.88505491651412, 4.738836380152409},
    ATransparent={43.52288106859183, 0.303778762595245, 9.60065333651851, 8.586165822797666, 11.400747615507708, 1.2800799998882342, 16.7572400516897, 4.738780000000157, 29.761928821574823, 0.5443214701825972, 11.400747615507708, 0.6177260754961884, 21.497929711878125, 17.409205654021648, 2.7176036704351048, 20.191472673908976, 19.34337649596921, 31.696630457688386, 21.47481376536753, 9.88505491651412, 4.738836380152409},
    AExt={217.61440534295912, 1.5188938129762248, 48.003266682592546, 42.930829113988324, 57.003738077538536, 6.400399999441171, 83.78620025844849, 23.693900000000788, 148.8096441078741, 2.7216073509129863, 57.003738077538536, 3.088630377480942, 107.48964855939062, 87.04602827010824, 13.588018352175522, 100.95736336954486, 96.71688247984605, 158.48315228844194, 107.37406882683763, 49.425274582570594, 23.694181900762047})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  AixLib.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=21,
    wfGro=0.0,
    wfWall={0.15139974588489105, 0.00105673214486108, 0.03339706471148057, 0.029868043929545923, 0.03965891617251548, 0.0044529172227816514, 0.058292140209182726, 0.016484434628160998, 0.10353056484310616, 0.0018934898205717958, 0.03965891617251548, 0.0021488368545547636, 0.07478321782742461, 0.06056008350924103, 0.009453521803193306, 0.07023854480253157, 0.06728833694235643, 0.11026066470963493, 0.07470280613725921, 0.0343863909206701, 0.016484630753521138},
    wfWin={0.15139974588489105, 0.0010567321448610798, 0.033397064711480566, 0.029868043929545916, 0.03965891617251548, 0.0044529172227816514, 0.05829214020918272, 0.016484434628160998, 0.10353056484310617, 0.0018934898205717953, 0.03965891617251548, 0.002148836854554764, 0.0747832178274246, 0.06056008350924102, 0.009453521803193308, 0.07023854480253158, 0.06728833694235642, 0.1102606647096349, 0.07470280613725921, 0.034386390920670105, 0.016484630753521138},
    withLongwave=true,
    aExt=0.5,
    hConWallOut=20.0,
    hRad=5.0,
  ...
  Modelica.Blocks.Math.Add solRad[21]
  ...
  Modelica.Blocks.Sources.Constant const[21](each k=0)
  ...
  AixLib.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant hConWall(k=25.0*1437.3498718314295)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.000000000000007*287.4699743662858)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://teaser/B1180GustavTschermakGasse3/B1180GustavTschermakGasse3_Models/InternalGains_B1180GustavTschermakGasse3SingleDwelling.txt"),
    columns={2,3,4})
  ...
  AixLib.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007 eqAirTempVDI(
    ...
    n=5,
    wfWall={0.6517432968914652, 0.04730469454715403, 0.026065299663208162, 0.13744335444908642, 0.13744335444908642},
    wfWin={0, 0, 0, 0, 0},
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=10070.274304959285)
    "Outdoor coefficient of heat transfer for roof"
    annotation (Placement(transformation(extent={{4,-4},{-4,4}},rotation=0,
    origin={86,27})));
  Modelica.Blocks.Sources.Constant const1[5](each k=0)
    "Sets sunblind signal to zero (open)" annotation (Placement(transformation(
        extent={{3,-3},{-3,3}},
        rotation=90,
        origin={40,71})));
  Modelica.Blocks.Math.Add solRadRoof[5]
    "Sums up solar radiation of both directions"
    annotation (Placement(transformation(extent={{4,76},{14,86}})));
  AixLib.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTilRoof[5](    til={1.570796326794897, 0.0, 1.570796326794897, 1.5707963267948963, 1.5707963267948963},
    azi={1.568114551058147, 0.0, -1.581475532453958, -1.5736864921607283, 1.5679061614290648})
    "Calculates direct solar radiation on titled surface for both directions"
    annotation (Placement(transformation(extent={{-68,74},{-48,94}})));
  AixLib.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTilRoof[5](    til={1.570796326794897, 0.0, 1.570796326794897, 1.5707963267948963, 1.5707963267948963},
    azi={1.568114551058147, 0.0, -1.581475532453958, -1.5736864921607283, 1.5679061614290648})
...
equation
  ...
  events=false));
end B1180GustavTschermakGasse3_SingleDwelling;
